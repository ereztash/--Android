...
**זיקוק DictaBERT לטבלה** (`D1`) — נכשל **מבנית**. DictaBERT הוכיח תקרה של 98.6% מול 62.31% שלנו, ו-97.5% דווקא במקומות שבהם המודל שלנו עיוור לגמרי. אבל טבלת שינון לא יכולה להגיע לשם: **העיוורון יושב בזנב הארוך וטבלה מכסה את הראש**. הטבלה הגדולה ביותר שנכנסת בתקציב כיסתה 1.8%.
